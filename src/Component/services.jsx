...
const Services = ({ services = [], showLongDescription = false }) => {
  return (
          ...
          <div key={service.id} className="service-item bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="service-content">
              ...
              <p className="text-gray-700 mb-4">
                {showLongDescription ? `${service.description} - Here is a longer description of the service.` : service.description}
              </p>
              <a
                href="/contact"
